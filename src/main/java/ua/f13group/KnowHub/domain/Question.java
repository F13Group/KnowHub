...
@NamedNativeQuery(name = "nativeQuestion.selectBookmarked", query = "select * from questions q inner join bookmarks b on " +
         ""+ "b.question_id = q.question_id where b.user_id = :userId", resultClass = Question.class)
