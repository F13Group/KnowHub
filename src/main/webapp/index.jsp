...
<script>
	$(document).ready(function() {
		...
		$.getJSON(questionUrl, function(data) {
			...
			$("#questionsList").append("<div class=divRow><div class=divCell_2 style=width:200px align=right>SHOW<select><option>6</option><option>10</option><option>14</option></select></div><div class=divCell_2 style=width:640px align=center><input type=button value=&lt;&lt;> <input type=button value=&lt;> <span><input type=button class=checkedPage value=1></span> <input type=button value=2> <input type=button value=3> <input type=button value=4> <input type=button value=5> <input type=button value=6> <input type=button value=&gt;> <input type=button value=&gt;&gt;></div></div>");
		});
	...
	function selectCategory(categoryId) {
		...
		$.getJSON(questionUrl, function(data) {
			...
			$("#questionsList").append("<div class=divRow><div class=divCell_2 style=width:200px align=right>SHOW<select><option>6</option><option>10</option><option>14</option></select></div><div class=divCell_2 style=width:640px align=center><input type=button value=&lt;&lt;> <input type=button value=&lt;> <span><input type=button class=checkedPage value=1></span> <input type=button value=2> <input type=button value=3> <input type=button value=4> <input type=button value=5> <input type=button value=6> <input type=button value=7> <input type=button value=&gt;> <input type=button value=&gt;&gt;></div></div>");			
		});
	}
</script>