...
<script>
	...
	function selectCategory(categoryId) {
		...
		$.getJSON(questionUrl, function(data) {
			var counter = 1;
			var items = [];
			$("#questionsList").empty().append("<div class=headRow><div class=divCell_header style=width:400px>Question</div><div class=divCell_header>Category</div><div class=divCell_header>Date</div><div class=divCell_header>Frequently asked</div></div>");
			if (data.length == 0) {
				$("#questionsList").append("<div class=divRow><div class=divCell_2 style=width:100% align=center>No questions found for this category</div></div>");
			} else {
				$.each(data, function(index, value) {
					var date = new Date(value.loadDate);
					counter++;
