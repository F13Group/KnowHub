			...
			if (data.length == 0) {
				...
				$.each($(data).get().reverse(), function(index, value) {
					...
					var dd = unformatted_date.getDate();
		           	...
		           	var date = dd+'/'+mm+'/'+yyyy;
		           	if (counter % 2 != 0) {
		           		$("<div class=divRow><div class=divCell_2 style=width:400px;background:#FFF><div class=divQuestionColor>" + value.value + "</div></div><div class=divCell_2 style=background:#FFF>" + value.category.value + "</div><div class=divCell_2 style=background:#FFF>" + date +"</div><div class=divCell_2 style=background:#FFF>" + value.rating + "</div></div>").insertAfter("#headRow");
		           	}else{
		           		$("<div class=divRow><div class=divCell_2 style=width:400px;background:#EEE><div class=divQuestionColor>" + value.value + "</div></div><div class=divCell_2 style=background:#EEE>" + value.category.value + "</div><div class=divCell_2 style=background:#EEE>" + date +"</div><div class=divCell_2 style=background:#EEE>" + value.rating + "</div></div>").insertAfter("#headRow");
		           	}
			});
		}						
	});
