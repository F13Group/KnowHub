...
<head>
	...
	<!-- Likes style -->
	<link href="${pageContext.servletContext.contextPath}/resources/style/css/likes.css" rel="stylesheet">
	...
	<script
			src="${pageContext.servletContext.contextPath}/resources/js/singleQuestion.js"></script>
	<script
	...
	<script
			src="${pageContext.servletContext.contextPath}/resources/js/likes.js"></script>
</head>
				...
				<div id="links">
					<div class="nav-left">
						...
						<sec:authorize access="isAnonymous()">
							<a href="${pageContext.servletContext.contextPath}/signup">Sign
								up</a>
							<a href="${pageContext.servletContext.contextPath}/login">Log
								in</a>
						</sec:authorize>
						<sec:authorize access="isAuthenticated()">
							<a href="${pageContext.servletContext.contextPath}/logout">Log
								off</a>
						</sec:authorize>
						<a href="#">Help</a>
					</div>
...
<div class="container">
	...
	<div class="tabbable">
			...
			<div id="questionsList"
				...
				<div class="row">
					<div id="headRow" class="headRow">
						...
						<div id="wasBookmarked"
							 class="divCell_header col-lg-4 col-md-4 col-sm-4">Bookmark
							this question:</div>
					</div>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 divCell_Left">
						<div id="qAuthor">
							<img
									src='${pageContext.servletContext.contextPath}/resources/img/account.png'
									width="20" height="20" />
						</div>
						<div id="addedDate"></div>
					</div>
					<div id="qDescription"
						 class="col-lg-10 col-md-10 col-sm-10 justified"></div>
				</div>
			</div>
		</div>
		...
		<div id="taggingRow" class="col-lg-10 col-md-10 col-sm-10 justified">
			<div class=row>
				<div class="divCell_2 col-lg-2 col-md-2 col-sm-2" id="qCategory"
					 style="height: 50px" align=left></div>
				<div class="divCell_2 col-lg-6 col-md-6 col-sm-6" id="qTag"
					 style="height: 50px" align=center></div>
				<div class="divCell_2 col-lg-4 col-md-4 col-sm-4"
					 id="otherQuestions" style="height: 50px" align=center>
					<a href="#">Show other questions posted by this user</a>
				</div>
			</div>
		</div>
		...
		<div id="taggingRow" class="col-lg-10 col-md-10 col-sm-10 justified">
			<div class=row>
				<div class="divCell_2 col-lg-2 col-md-2 col-sm-2" id="wasAsked"
					 style="height: 60px" align=left></div>
				<div class="divCell_2 col-lg-6 col-md-6 col-sm-6" id="viewed"
					 style="height: 60px" align=left>
					<img
							src='${pageContext.servletContext.contextPath}/resources/img/eye.png'
							width="20" height="20" />
				</div>
				<div class="divCell_2 col-lg-4 col-md-4 col-sm-4" id="showComments"
		...
		<div id="userComments"
			 class="col-lg-10 col-md-10 col-sm-10 justified">
			<div class="row">
				<b>Comments:</b>
			</div>
		</div>
